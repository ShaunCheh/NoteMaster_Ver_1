//
//  macOSFretboardControlPanelView.swift
//  NoteMaster_Ver_1
//
...
final class macOSFretboardControlPanelView: NSView {
    ...
    private var sectionViews: [FretboardControlSectionID: SectionView] = [:]
    private var controlViewsByID: [FretboardControlRowID: NSView] = [:]
    ...
    convenience init(model: FretboardControlPanelModel) {
    ...
    private func syncControlRows(
        ...
        for section: FretboardControlSection
    ) {
    ...
    private func sectionView(for id: FretboardControlSectionID) -> SectionView {
    ...
    private func controlView(for row: FretboardControlRow) -> NSView {
        switch row {
    ...
    private func removeObsoleteControlViews(notIn validIDs: Set<FretboardControlRowID>) {
    ...
    private func detachControlViewIfNeeded(for id: FretboardControlRowID) {
    ...
    private func removeObsoleteSectionViews(notIn validIDs: Set<FretboardControlSectionID>) {
