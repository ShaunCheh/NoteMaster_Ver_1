//
//  iOSFretboardControlPanelView.swift
//  NoteMaster_Ver_1
//
...
final class iOSFretboardControlPanelView: UIView {
    ...
    private var controlViewsByID: [FretboardControlRowID: UIView] = [:]
    ...
    private func controlView(for row: FretboardControlRow) -> UIView {
        switch row {
